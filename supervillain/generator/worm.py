...
class UndirectedWorm(ReadWriteable):
    ...
    def burrow(self, cfg, currentsite):
        ...
        The probability of moving in a direction is given by :math:`\frac{A_\ell}{N}` where
