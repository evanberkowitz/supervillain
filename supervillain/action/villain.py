...
from supervillain.lattice.compact import Lattice, Form, d
...
class Villain(ReadWriteable):
    ...
    def gauge_transform(self, configuration, k):
        ...
        k: Form
            The gauge transformation parameter $k$; must be an integer-valued 0-form.
        ...
        return {
            ...
            'n':   configuration['n'] + d(k).astype(int),
        }
